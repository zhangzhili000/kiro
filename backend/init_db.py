...
from kiro_platform.core.database import engine, Base
from kiro_platform.models import (
    User, Comment, UserFavorite, DocumentLike,
    Subscription, Notification, AuditLog, SearchHistory, Role,
)
from kiro_knbase.models import (
    Document, DocumentVersion, DocumentShare,
    Category, Tag, DocumentTag,
...
def create_admin_user():
    from kiro_platform.core.security import get_password_hash
