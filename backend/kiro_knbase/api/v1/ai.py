...
from kiro_knbase.models.ai_models import DocumentVector, AIConversation
from kiro_knbase.schemas.ai_schemas import (
...
from kiro_knbase.models.ai_models import AIConfig, PromptTemplate
...
async def process_document(
    ...
    try:
        ...
        for idx, chunk in enumerate(chunks):
            embedding_result = ai_client.get_embedding(chunk)
    ...
    async def stream_generator():
        try:
            ...
            done_data = {
                ...
                'data': {
                    'conversation_id': pending_conversation.id,
                    'conversation_uuid': pending_conversation.conversation_uuid,
                    'model': model_name,
                    'tokens': tokens,
                    'question_time': question_time.isoformat(),
                    'answer_time': answer_time.isoformat(),
