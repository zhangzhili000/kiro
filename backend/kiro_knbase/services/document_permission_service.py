...
from kiro_knbase.models.document_permission import DocumentPermission
from kiro_knbase.models.document import Document
from kiro_platform.models.user import User
from kiro_platform.models.team import Team, TeamMember
from kiro_knbase.schemas.document_permission import (
...
def get_document_permissions_with_names(db: Session, document_id: int) -> List[dict]:
    ...
    for perm in permissions:
        target_name = None
        if perm.permission_type == PermissionType.TEAM.value:
            # 团队权限
